...
export const TRANSFER_INTENT_STREAM_NAME = 'TRANSFER_INTENT'
export const TRANSFER_INTENT_STREAM_SUBJECT: string = TRANSFER_INTENT_STREAM_NAME.toLowerCase()
...
export const TRANSFER_INTENT_STREAM: StreamConfig = {
  name: TRANSFER_INTENT_STREAM_NAME,
...
export function transferIntentConsumer(type: TransferIntentEventType): ConsumerConfig {
  return {
    stream: TRANSFER_INTENT_STREAM_NAME,
