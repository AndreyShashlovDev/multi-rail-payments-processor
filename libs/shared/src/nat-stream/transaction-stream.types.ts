...
export const TRANSACTION_STREAM_NAME = 'TRANSACTION'
export const TRANSACTION_STREAM_SUBJECT: string = TRANSACTION_STREAM_NAME.toLowerCase()
...
export function transactionConsumer(integration: IntegrationType): ConsumerConfig {
  return {
    stream: TRANSACTION_STREAM_NAME,
