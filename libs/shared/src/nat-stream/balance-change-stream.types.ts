...
export const BALANCE_CHANGE_STREAM_NAME = 'BALANCE_CHANGE'
export const BALANCE_CHANGE_STREAM_SUBJECT: string = BALANCE_CHANGE_STREAM_NAME.toLowerCase()
...
export const BALANCE_CHANGE_STREAM: StreamConfig = {
  name: BALANCE_CHANGE_STREAM_NAME,
...
export function balanceChangeConsumer(integration: IntegrationType): ConsumerConfig {
  return {
    stream: BALANCE_CHANGE_STREAM_NAME,
