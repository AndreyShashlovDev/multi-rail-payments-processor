...
export const BALANCE_UPDATED_STEAM_NAME = 'BALANCE_UPDATED'
export const BALANCE_UPDATED_STREAM_SUBJECT: string = BALANCE_UPDATED_STEAM_NAME.toLowerCase()

export const BALANCE_UPDATED_STREAM: StreamConfig = {
  name: BALANCE_UPDATED_STEAM_NAME,
...
export const BALANCE_UPDATED_CONSUMER: ConsumerConfig = {
  stream: BALANCE_UPDATED_STEAM_NAME,
