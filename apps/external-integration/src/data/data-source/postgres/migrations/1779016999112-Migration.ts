...
export class Migration1779016999112 implements MigrationInterface {
  name = 'Migration1779016999112'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "external_integration"."transfer_intent" ADD CONSTRAINT "FK_fcc3e0b7a11be98cd2dc66c6f17" FOREIGN KEY ("transaction_intent_id") REFERENCES "external_integration"."transaction_intent"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "external_integration"."transfer_intent" DROP CONSTRAINT "FK_fcc3e0b7a11be98cd2dc66c6f17"`,
    )
    await queryRunner.query(
