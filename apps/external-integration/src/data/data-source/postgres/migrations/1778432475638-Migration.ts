...
export class Migration1778432475638 implements MigrationInterface {
    name = 'Migration1778432475638'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "external_integration"."transaction" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" BIGSERIAL NOT NULL, "execution_type" smallint NOT NULL, "integration" smallint NOT NULL, "source_tx_id" text NOT NULL, "block_id" text, "block_time" TIMESTAMP WITH TIME ZONE, "status" smallint NOT NULL, "metadata" jsonb, "fee" text, "fee_currency" text NOT NULL, CONSTRAINT "idx_unique_sourcetxid_integration" UNIQUE ("source_tx_id", "integration"), CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "external_integration"."internal_block" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "integration" smallint NOT NULL, "block_number" bigint NOT NULL DEFAULT '0', CONSTRAINT "idx_unique_internal_block" UNIQUE ("integration"), CONSTRAINT "PK_34e9bd3d632203a376159afe1e7" PRIMARY KEY ("id"))`);
