...
export class Migration1773580047473 implements MigrationInterface {
    name = 'Migration1773580047473'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "external_integration"."transaction" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" BIGSERIAL NOT NULL, "integration" smallint NOT NULL, "source_tx_id" text NOT NULL, "block_id" text, "block_time" TIMESTAMP, "status" smallint NOT NULL, "metadata" jsonb, "fee" text, "fee_currency" text NOT NULL, CONSTRAINT "idx_unique_sourcetxid_integration" UNIQUE ("source_tx_id", "integration"), CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
