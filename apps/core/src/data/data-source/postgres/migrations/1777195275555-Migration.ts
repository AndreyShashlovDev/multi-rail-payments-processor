...
export class Migration1777195275555 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "core"."integration_currency" ("id" SERIAL NOT NULL, "code" text NOT NULL, "name" text NOT NULL, "symbol" text NOT NULL, "integration" smallint NOT NULL, "currency" text NOT NULL, "display_decimals" smallint NOT NULL, "minor_unit" smallint NOT NULL, CONSTRAINT "idx_unique_integration_currency_integration_currency" UNIQUE ("integration", "currency"), CONSTRAINT "PK_8d0a82aba16869d53a12ea7c385" PRIMARY KEY ("id"))`);
