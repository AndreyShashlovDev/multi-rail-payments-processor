...
export class Migration1781368237828 implements MigrationInterface {
  name = 'Migration1781368237828'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "core"."payout_intent" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "operation_type" smallint NOT NULL, "initiator_account_id" uuid NOT NULL, "initiator_user_id" uuid NOT NULL, "from_amount" numeric(60,30) NOT NULL, "from_currency" text NOT NULL, "from_integration" smallint NOT NULL, "estimated_fee" numeric(60,30) NOT NULL, "estimated_fee_currency" text NOT NULL, "platform_fee" numeric(60,30), "platform_fee_integration_account" text, "platform_fee_platform_account" uuid, "platform_fee_account_id" bigint, "integration_fee" numeric(60,30), "integration_fee_currency" text NOT NULL, "integration_fee_rate" numeric(60,30) NOT NULL, "exchange_rate" numeric(60,30), "to_integration_account" text NOT NULL, "to_platform_account" uuid, "to_id" bigint, "to_amount" numeric(60,30) NOT NULL, "to_currency" text NOT NULL, "to_integration" smallint NOT NULL, "status" smallint NOT NULL DEFAULT '1', "metadata" jsonb, CONSTRAINT "PK_a4dd54c9a374c6744f8391112e7" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(`CREATE INDEX "idx_payout_intent_status" ON "core"."payout_intent" ("status") `)
    await queryRunner.query(
      `CREATE TABLE "core"."account" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "owner" uuid NOT NULL, "role" smallint NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "core"."integration_currency" ("id" SERIAL NOT NULL, "code" text NOT NULL, "name" text NOT NULL, "symbol" text NOT NULL, "integration" smallint NOT NULL, "currency" text NOT NULL, "display_decimals" smallint NOT NULL, "minor_unit" smallint NOT NULL, CONSTRAINT "idx_unique_integration_currency_integration_currency" UNIQUE ("integration", "currency"), CONSTRAINT "PK_8d0a82aba16869d53a12ea7c385" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "core"."escrow" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" BIGSERIAL NOT NULL, "integration" smallint NOT NULL, "platform_account_id" uuid, "integration_account" text, "amount" numeric(60,30) NOT NULL, "currency" text NOT NULL, "type" smallint NOT NULL, "intent_type" text, "intent_id" text, "status" smallint NOT NULL, "metadata" jsonb, "metadata_hash" text NOT NULL, "deleted_at" TIMESTAMP, CONSTRAINT "PK_4aafc323d34fd7979460661ab4a" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(`CREATE INDEX "idx_escrow_metadata_hash" ON "core"."escrow" ("metadata_hash") `)
    await queryRunner.query(
      `CREATE INDEX "idx_escrow_intent_type_intent_id" ON "core"."escrow" ("intent_type", "intent_id") `,
    )
    await queryRunner.query(`CREATE INDEX "idx_escrow_status_created_at" ON "core"."escrow" ("status", "created_at") `)
    await queryRunner.query(
      `CREATE TABLE "core"."inbox" ("service_name" character varying NOT NULL, "idempotency_key" character varying NOT NULL, "data" text, CONSTRAINT "PK_45875d77b98fb32e13799702ac6" PRIMARY KEY ("service_name", "idempotency_key"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "core"."receipt" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "intent_id" uuid NOT NULL, "intent_type" smallint NOT NULL, "amount" numeric(60,30) NOT NULL, "integration" smallint NOT NULL, "source_tx_id" text NOT NULL, "tx_id" bigint NOT NULL, "transfer_ids" bigint array NOT NULL, "currency" text NOT NULL, "executed_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_b4b9ec7d164235fbba023da9832" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "core"."payout_inbox_transfer" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" BIGSERIAL NOT NULL, "key" text NOT NULL, "tx_id" bigint NOT NULL, "transfer_id" bigint NOT NULL, "integration" smallint NOT NULL, "intent_id" uuid NOT NULL, "tx_status" text NOT NULL, "data" json NOT NULL, "state" smallint NOT NULL, "reason" text, "deleted_at" TIMESTAMP, CONSTRAINT "idx_unique_integration_intentid_txid_transferid_txstatus" UNIQUE ("integration", "intent_id", "tx_id", "transfer_id", "tx_status"), CONSTRAINT "PK_779d48045eb066ac6706e9dcda3" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE INDEX "idx_payout_inbox_transfer_key_tx_id_deleted" ON "core"."payout_inbox_transfer" ("key", "tx_id") WHERE "deleted_at" IS NULL`,
    )
    await queryRunner.query(
      `CREATE INDEX "idx_payout_inbox_transfer_key_state_deleted" ON "core"."payout_inbox_transfer" ("key", "state") WHERE "deleted_at" IS NULL`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(`CREATE INDEX "idx_outbox_status_created_at" ON "core"."outbox" ("status", "created_at") `)
    await queryRunner.query(
      `ALTER TABLE "core"."integration_account_link" ADD CONSTRAINT "FK_c34758bc84aa67e0a5fc697f236" FOREIGN KEY ("integration_account_id") REFERENCES "core"."integration_account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "core"."integration_account_link" DROP CONSTRAINT "FK_c34758bc84aa67e0a5fc697f236"`,
    )
    ...
    await queryRunner.query(`DROP TABLE "core"."receipt"`)
    ...
    await queryRunner.query(`DROP TABLE "core"."payment_amount_accumulator"`)
