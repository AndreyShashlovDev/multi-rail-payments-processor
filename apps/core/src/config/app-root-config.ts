...
import ledgerGrpcConfig, { LedgerGrpcConfig } from './ledger.grpc.config'
import grpcConfig, { GrpcConfig } from './grpc.config'
import loggingConfig from './logging.config'

export const AppConfigs = [appConfig, postgresConfig, natsConfig, loggingConfig, ledgerGrpcConfig, grpcConfig]
